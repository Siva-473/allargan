...
@Component({
  ...
  templateUrl: './core-disease-training.component.html',
  styleUrls: ['./core-disease-training.component.css']
})
export class CoreDiseaseTrainingComponent implements OnInit {
