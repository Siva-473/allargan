...
@Component({
  ...
  templateUrl: './core-product-training.component.html',
  styleUrls: ['./core-product-training.component.css']
})
export class CoreProductTrainingComponent implements OnInit {
